...
void Enemy::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Enemy::dead)) {
                *result = 0;
                return;
            }
        }
...
void *Enemy::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Tile"))
        return static_cast< Tile*>(const_cast< Enemy*>(this));
...
void PEnemy::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PEnemy::poisonLevelUpdated)) {
                *result = 0;
                return;
            }
        }
...
void Protagonist::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Protagonist::healthChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (Protagonist::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Protagonist::energyChanged)) {
                *result = 2;
                return;
            }
        }
